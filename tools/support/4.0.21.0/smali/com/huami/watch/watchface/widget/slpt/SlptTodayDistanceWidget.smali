.class public Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;
...
.method public constructor <init>(Landroid/content/Context;IIIIIZ)V
    ...
    iput-object p1, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->mContext:Landroid/content/Context;
...
.method public getDataView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;
    ...
    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getDotView()Lcom/ingenic/iwds/slpt/view/core/SlptPictureView;
    ...
    new-instance v2, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceFView;

    invoke-direct {v2}, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceFView;-><init>()V

    new-instance v3, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceLView;

    invoke-direct {v3}, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceLView;-><init>()V

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getDefaultNumMem()[[B

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceFView;->setImagePictureArray([[B)Z

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getDefaultNumMem()[[B

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/ingenic/iwds/slpt/view/sport/SlptTodaySportDistanceLView;->setImagePictureArray([[B)Z
...
.method public getIconView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;
    ...
    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getModel()I
    ...
    iget-object v1, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->mContext:Landroid/content/Context;

    const-string v2, "datawidget/slpt/watchface_custom_fun_icon_slpt_run.png"
    ...
    const-string v2, "datawidget/model_4/icon/watchface_custom_fun_icon_slpt_run.png"
    ...
    const-string v2, "datawidget/model_3/8C/icon/watchface_custom_fun_icon_slpt_run.png"
    ...
    const-string v2, "datawidget/slpt/watchface_custom_fun_icon_slpt_run_2.png"
    ...
    const-string v2, "datawidget/slpt/watchface_custom_fun_icon_slpt_run_1.png"
...
.method public getProgressView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;
    ...
    iget-object v2, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->mContext:Landroid/content/Context;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->checkNeed26WC()Z
    ...
    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getX()I

    move-result v3

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getY()I

    move-result v4

    invoke-virtual {v2, v3, v4}, Lcom/ingenic/iwds/slpt/view/core/SlptPictureView;->setStart(II)V

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getWidth()I

    move-result v3

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getHeight()I
    ...
    new-instance v2, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;

    invoke-direct {v2}, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;-><init>()V

    invoke-virtual {v2, v1}, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;->setImagePicture([B)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;->setStart(II)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;->setRect(II)V
    ...
    iput v1, v2, Lcom/ingenic/iwds/slpt/view/arc/SlptTodayDistanceArcAnglePicView;->len_angle:I
...
.method public getWidgetView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;
    ...
    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getDataView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;

    move-result-object v0

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getIconView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;

    move-result-object v1

    invoke-virtual {p0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->getProgressView()Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;
    ...
    invoke-virtual {p0, v1}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->setIconPosition(Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;)V

    invoke-virtual {p0, v0}, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->setDataPosition(Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;)V
    ...
    iget v2, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->dataPadLeft:I

    const/4 v4, 0x0

    invoke-virtual {v0, v2, v4, v4, v4}, Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;->setPadding(IIII)V
...
.method public setDataPosition(Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;)V
    ...
    iget v2, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->dataPadTop:I
...
.method public setIconPosition(Lcom/ingenic/iwds/slpt/view/core/SlptViewComponent;)V
    ...
    iget v2, p0, Lcom/huami/watch/watchface/widget/slpt/SlptTodayDistanceWidget;->iconPadTop:I
